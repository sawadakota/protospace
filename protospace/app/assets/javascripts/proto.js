...
$("#like-button").on("click", function(){
  ...
  like_function(#{@proto.id}, $(this), $heart, $likeSum)
});

function like_function(id, button, heart, sum) {
  if (button.hasClass("decrement")){
      $.ajax({url: "/likes/" + id, type: "delete", data: {proto_id: id, dataType: "json"}})
      .done(function(data){
      ...
      $.ajax({url: "/likes", type: "proto", data: {proto_id: id, dataType: "json"}})
      .done(function(data){
